use kzen_paillier::{Add, Decrypt, DecryptionKey, Encrypt, EncryptionKey, KeyGeneration, Paillier};
...
impl FheEngine for PrototypeFhe {
    ...
    fn encrypt(&self, key: &FheKeyPair, m: u64) -> Vec<u8> {
        ...
        use kzen_paillier::{BigInt as KzenBigInt, RawCiphertext, RawPlaintext};
