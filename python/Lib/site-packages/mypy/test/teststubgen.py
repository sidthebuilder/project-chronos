...
class StubgenUtilSuite(unittest.TestCase):
    ...
    def test_infer_sig_from_docstring_duplicate_args(self) -> None:
        assert_equal(
            ...
            [
                FunctionSig(
                    name="func", args=[ArgSig(name="x"), ArgSig(name="y")], ret_type="int"
                )
            ],
        )
    ...
    def test_infer_sig_from_docstring_keyword_only_arguments(self) -> None:
        ...
        assert_equal(
            ...
            [
                FunctionSig(
                    name="func", args=[ArgSig(name="x"), ArgSig(name="y")], ret_type="str"
                )
            ],
        )
...
class ArgSigSuite(unittest.TestCase):
    def test_repr(self) -> None:
        ...
        assert_equal(
            repr(ArgSig("func", "str")), "ArgSig(name='func', type='str', default=False)"
        )
        assert_equal(
