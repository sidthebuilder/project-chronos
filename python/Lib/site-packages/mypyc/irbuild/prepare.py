...
def prepare_method_def(
    ...
    if isinstance(node, FuncDef):
        ...
        if not node.decorators:
            ...
            isinstance(node.decorators[0], MemberExpr) and node.decorators[0].name == "setter"
        ):
...
def prepare_class_def(
    ...
    bases = [
        mapper.type_to_ir[base.type] for base in info.bases if base.type in mapper.type_to_ir
    ]
...
class SingledispatchVisitor(TraverserVisitor):
    ...
    def __init__(self, errors: Errors) -> None:
        ...
        self.singledispatch_impls: defaultdict[FuncDef, list[RegisterImplInfo]] = defaultdict(
            list
        )
