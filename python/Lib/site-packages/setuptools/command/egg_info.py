...
class InfoCommon:
    ...
    def _maybe_tag(self, version):
        ...
        """
        return (
            version if self.vtags and self._already_tagged(version) else version + self.vtags
        )
...
class FileList(_FileList):
    ...
    def graft(self, dir):
        ...
        found = [
            item for match_dir in glob(dir) for item in distutils.filelist.findall(match_dir)
        ]
        self.extend(found)
        return bool(found)
