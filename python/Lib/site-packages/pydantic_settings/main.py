...
class BaseSettings(BaseModel):
    ...
    def _settings_init_sources(
        ...
        env_file = (
            _env_file if _env_file != ENV_FILE_SENTINEL else cls.model_config.get("env_file")
        )
        env_file_encoding = (
            _env_file_encoding
        ...
        secrets_dir = (
            _secrets_dir if _secrets_dir is not None else cls.model_config.get("secrets_dir")
        )
...
class CliApp:
    ...
    def format_help(
        ...
        return (
            help_message if not strip_ansi_color else CliApp._ansi_color.sub("", help_message)
        )
