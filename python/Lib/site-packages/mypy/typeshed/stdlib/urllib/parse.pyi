...
if sys.version_info >= (3, 15):
    ...
    class SplitResult(
        _SplitResultBase[str, _StrComponentT], _NetlocResultMixinStr, Generic[_StrComponentT]
    ): ...
    class ParseResult(
        _ParseResultBase[str, _StrComponentT], _NetlocResultMixinStr, Generic[_StrComponentT]
    ): ...
