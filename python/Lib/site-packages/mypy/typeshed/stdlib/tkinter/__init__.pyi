...
class Canvas(Widget, XView, YView):
    ...
    def addtag_enclosed(
        self, newtag: str, x1: float | str, y1: float | str, x2: float | str, y2: float | str
    ) -> None: ...
...
class Text(Widget, XView, YView):
    ...
    @overload
    def image_cget(
        self, index: str | float | _tkinter.Tcl_Obj | Widget, option: Literal["image", "name"]
    ) -> str: ...
    @overload
    def image_cget(
        self, index: str | float | _tkinter.Tcl_Obj | Widget, option: Literal["padx", "pady"]
    ) -> int: ...
    @overload
    def image_cget(
