...
def hardcoded_password_string(context):
    ...
    **Config Options:**
    ...
    elif isinstance(node._bandit_parent, ast.Subscript) and RE_CANDIDATES.search(node.value):
    ...
    elif isinstance(node._bandit_parent, ast.Index) and RE_CANDIDATES.search(node.value):
